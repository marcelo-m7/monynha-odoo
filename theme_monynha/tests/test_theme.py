...
class TestMonynhaTheme(HttpCase):
    ...
    def test_core_snippets_registered(self):
        keys = {"theme_monynha.s_monynha_hero", "theme_monynha.s_monynha_services", "theme_monynha.s_monynha_process", "theme_monynha.s_monynha_labs", "theme_monynha.s_monynha_cta"}
